...
{
    [Authorize]
    public class AdminFeaturesController : AdminEntityEditorController<Feature, FeatureInputViewModel>
    {
        ...
        {
            return base.GetEntities().Where(f => f.IsFunctionality).ToList();
        }        
    }
}
